...
<body>
            ...
            <div id="courses">
                ...
                <?php
                     ...
                     <div class='course-cont'>
                         <div class='modules'>
                             <a href='Teacher/Courses_page.php?course={$C_name}'>{$row['C_name']}</h5></a>
                         </div>
                     </div>
                 </div>";
                     }
                ...
                <!-- <div class="course-container" id="py">
                    <div class="course-cont">
                        <div class="modules">
                            <a href="Teacher/Python_Coursepage.php"><h5>Python</h5></a>
                        </div>
                    </div>
                </div>
                <div class="course-container" id="Aoa">
                    <div class="course-cont">
                        <div class="modules">
                            <a href="Teacher/Courses_page.php"><h5>Analysis of Algorithm</h5></a>
                        </div>
                    </div>
                </div>
                <div class="course-container" id="os">
                    <div class="course-cont">
                        <div class="modules">
                            <a href="Teacher/OS_Coursepage.php"><h5>Operating System</h5></a>
                        </div>
                    </div>
                </div>
                <div class="course-container" id="dbms">
                    <div class="course-cont">
                        <div class="modules">
                            <a href="Teacher/DBMS_Coursepage.php"><h5>Database Management System</h5></a>
                        </div>
                    </div>
                </div>
                <div class="course-container" id="mp">
                    <div class="course-cont">
                        <div class="modules">
                            <a href="Teacher/MP_Coursepage.php"><h5>Microprocessor</h5></a>
                        </div>
                    </div>
                </div> -->
    ...
    <script src="Teacher/Course_page.js" defer></script>
