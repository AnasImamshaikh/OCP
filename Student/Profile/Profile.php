<?php
    ...
    $s_id =$_SESSION['S_id'];
    $sql = "UPDATE `student` SET `s_image`='$ImageName' WHERE S_id = '$s_id'";
                ...
                <div class="Profile-content">
                    <form action="Profile.php" method="post" enctype="multipart/form-data">
                        ...
                        <div-cont>
                            ...
                            <input type="text" placeholder="<?php echo "{$_SESSION['S_phone']}"; ?>" disabled>
                        </div-cont>
                        <div-cont>
                            <label><b>Date of Birth</b></label>
                            <input type="text" placeholder="<?php echo "{$_SESSION['S_DOB']}"; ?>" disabled>
                        </div-cont>
                        <div-cont>
                            <label><b>Age</b></label>
                            <input type="text" placeholder="<?php echo "{$_SESSION['S_Age']}"; ?>" disabled>
                        </div-cont>
                        <div-cont>
                            <label><b>Upload Image</b></label>
                            <input type="file" name="profile-img" required>
                        </div-cont>
                        <div-cont>
