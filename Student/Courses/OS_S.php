...
<head>
    ...
    <link rel="stylesheet" href="OS_S.css">
        ...
        <div class="Section-Container">
            ...
            <div id="courses">
                ...
                <div class="course-container">
                    <div id="course-cont">
                        <div class="modules">
                            <h5>Module 1 : Operating System Overview </h5>
                         </div>
<!--
                        <div class="form-model">
                             <button class="module-edit w3-button w3-purple w3-large" onclick="document.getElementById('id01').style.display='block'">Add</button>
                             <div class="w3-container">
                                ...
                                <form class="w3-container" method="POST" action="upload.php" enctype="multipart/form-data">
                                  <div class="w3-section">
                                    ...
                                    <button class="w3-button w3-block w3-purple w3-section w3-padding" type="submit" name="upload">Submit</button>
                                  </div>
                                </form>
            ...
            <div id="card">
                <div>
                    <div id="info">
                        ...
                        <img src="../../image/OS.jpg"
                            alt="">
                        <p> <strong>Name :</strong> Prof. Rukhsar Riaz Haji</p>
                        <p> <strong>Experience :</strong> 5 Years</p>
                        <p> <strong>Email :</strong> rukhsar@eng.rizvi.edu.in</p>
                        <p> <strong>Research Interest :</strong> : Image processing, Data Structure, 
                        algorithms, Internet Technology Database Managemen
                        </p>
                    </div>
                </div>
            </div>
