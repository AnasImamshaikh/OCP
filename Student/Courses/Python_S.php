...
<head>
    ...
    <link rel="stylesheet" href="Python_S.css">
...
<!--
                        <div class="form-model">
                             <button class="module-edit w3-button w3-pink w3-large" onclick="document.getElementById('id01').style.display='block'">Add</button>
                             <div class="w3-container">
                                ...
                                <form class="w3-container" method="POST" action="upload.php" enctype="multipart/form-data">
                                  <div class="w3-section">
                                    ...
                                    <button class="w3-button w3-block w3-pink w3-section w3-padding" type="submit" name="upload">Submit</button>
                                  </div>
                                </form>
