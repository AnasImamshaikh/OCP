...
<head>
    ...
    <link rel="stylesheet" href="DBMS_S.css">
...
<body>
        ...
        <div id="navbar">
            <div>
                ...
                <div id="navbar-content">
                    <div id="logo">
                        <img src="../../image/logo-dbms.png" alt="">
                    </div>
    ...
    <section>
        <div class="Section-Container">
            ...
            <div id="courses">
                <div>
                    <h2>Course => Database Management System
                    </h2>
                </div>
                ...
                <div class="course-container">
                    <div id="course-cont">
                        <div class="modules">
                            <h5>Module 1 : Introduction Database Concepts </h5>
                         </div>
<!--
                ...
                <div>
                    <div id="info">
                        ...
                        <img src="../../image/DBMS.jpg"
                            alt="">
                        <p> <strong>Name :</strong>Prof. Mansi Shah</p>
                        <p> <strong>Experience :</strong> 2 years</p>
                        <p> <strong>Email :</strong>  mansi.shah@eng.rizvi.edu.in</p>
                        <p> <strong>Research Interest :</strong> Database, Data Mining
                        </p>
                    </div>
                </div>
            </div>
