...
<head>
    ...
    <link rel="stylesheet" href="EM_S.css">
...
<body>
    ...
    <section>
        <div class="Section-Container">
            ...
            <div id="courses">
                <div>
                    <h2>Course => Engineering Mathematics
                    </h2>
                </div>
                ...
                <div>
                    <div id="info">
                        ...
                        <img src="../../image/EM.jpg"
                            alt="">
                        <p> <strong>Name :</strong> Peof. Dinesh Chouhan</p>
                        <p> <strong>Experience :</strong> 9 Years</p>
                        <p> <strong>Email :</strong> msc26897@eng.rizvi.edu.in</p>
                        <p> <strong>Research Interest :</strong> Linear Algebra, Complex Analysis, Differential Equation.
                        </p>
                    </div>
                </div>
            </div>
