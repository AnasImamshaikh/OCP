...
<head>
    ...
    <link rel="stylesheet" href="MP_S.css">
                ...
                <div>
                    <div id="info">
                        ...
                        <img src="../../image/MP.jpg"
                            alt="">
                        <p> <strong>Name :</strong> Prof. Sonalii K. Suryawanshi</p>
                        <p> <strong>Experience :</strong> 10 Years</p>
                        <p> <strong>Email :</strong> sonali.suryawanshi@eng.rizvi.edu.in</p>
                        <p> <strong>Research Interest :</strong>  Data mining and Warehouse, Machine Learning,
                         Artificial intelligence,Discrete Structures, Data Structure, 
                         Theory of Computation,Microprocessors, Computer Graphics.
                        </p>
                    </div>
                </div>
            </div>
